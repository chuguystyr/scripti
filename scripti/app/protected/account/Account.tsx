...
import { editAccount, changePassword, logout, deleteAccount } from '@/utils/serverActions';
...
const Account = ({data}: {data: any}) => {
  ...
  const [stateInfo, formActionInfo] = useFormState(editAccount, { message: '' });
  const [statePassword, formActionPassword] = useFormState(changePassword, { message: '' });
  return (
