  ...
  return (
    <div className="card w-fit h-fit p-4 bg-white shadow rounded">
        {!editable ? (
            ...
            <h1 className="text-center text-lg font-bold mb-3">{props.title}</h1>
            <FaEdit
            ...
            <div className="flex justify-between items-center mb-2">
              <span className="block mx-auto font-mono font-semibold">{props.controlForm}</span>
            </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <input
              ...
              onChange={(e) => setData({ ...data, controlForm: e.target.value })}
              name='controlForm'
              >
            ...
            <input
              ...
              onChange={(e) => setData({ ...data, teacherLectures: e.target.value })}
            ...
            <input
              ...
              onChange={(e) => setData({ ...data, lecturesLink: e.target.value })}
              name='lecturesLink'
              />
            <input
              className="text-center p-2 rounded border border-gray-300 w-full"
              ...
              onChange={(e) => setData({ ...data, teacherPractices: e.target.value })}
            ...
            <input
              ...
              onChange={(e) => setData({ ...data, practicesLink: e.target.value })}
              name='practicesLink'
              />
            <textarea
